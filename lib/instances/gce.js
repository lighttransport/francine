...
GceInstance.prototype._executeCommand = function _executeCommand(command, force) {
  var _this = this;
...
GceInstance.prototype._executeCommands = function _executeCommands(commands, force) {
  var _this = this;
