...
Worker.prototype._sendFinishTask = function (task) {
    var self = this;
...
Worker.prototype._sendFinishFetching = function (task) {
    var self = this;
...
Worker.prototype._prepareResources = function (task) {
    ...
    return q.then(function () {
        var d = Q.defer();
        self.sessions[task.session.name] = true;
        d.resolve();
        return d.promise;
    });
};
