...
function _queueTasksForExecution(executionName) {
  ...
  function run() {
    _this.log('Master',
      'numProducingTarget: ' + numProducingTarget +
      ' numProducingInQueue: ' + numProducingInQueue +
      ' numProducingFinished: ' + numProducingFinished +
      ' numProducingFailed: ' + numProducingFailed +
      ' numMediumReducingInQueue: ' + numMediumReducingInQueue +
      ' mediumReduced: ' + mediumReduced.length +
      ' isInFinalReducing: ' + isInFinalReducing);
  ...
  function queueProducingTask() {
    ...
    var taskName = _this.scheduler.createProducingTask(
  ...
  function queueMediumReducingTask(current, retry) {
    var taskName = _this.scheduler.createReducingTask(
    ...
    .then(function mediumReducingTaskFinished(info) {
      ...
      run();
    }, function mediumReducingTaskFailed(error) {
      numMediumReducingInQueue--;
