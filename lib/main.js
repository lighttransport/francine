...
function start(argv) {
  ...
  switch (argv.mode) {
    ...
    case 'createImage':
      francine = new ImageCreator(argv);
      break;
  }
  ...
  francine.log('Main', '# Francine: A Job Manager for Distributed Rendering');
...
if (argv.useMetadata) {
  ...
  console.log(
      'Francine: Instance type for metadata retrieval: ' + argv.instanceType);
