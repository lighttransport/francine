...
// Base class for Master, Worker, ImageCreator and Deployer
...
Runner.prototype.readConfig = function readConfig() {
  ...
  var attrs = {
    ...
    ltePath:      rc.ltePath,
    nanogiexPath: rc.nanogiexPath,

    // Configuration for ImageCreator
    // @fixme { currently only imageName in gce section is supported. }
    imageName: rc.gce.imageName ? rc.gce.imageName : 'default',
...
Runner.prototype.getWsPort = function getWsPort() {
  return this.wsPort;
};
...
Runner.prototype.getStatusInterval = function getStatusInterval() {
